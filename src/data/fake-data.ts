...
export function sortByPrice(direction:Direction):Product[]{
    return FAKE_PRODUCT_DATA.sort((a,b)=>{
        if (direction === "ASC") { //使用union + Equality Narrowing 概念
...
export function getProductById(id: string):Product{
    const product = FAKE_PRODUCT_DATA.find((item)=>{return item.id === id});
